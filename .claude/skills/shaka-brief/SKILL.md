---
name: shaka-brief
description: IMU satellite — 5-lensa ideation and Track Selection Gate. Use when exploring raw ideas, brainstorming, or running a pre-mortem. Outputs Idea Brief with recommended track (East Blue / Grand Line).
---
<!-- Stella Protocol by Aditya Uttama | https://www.linkedin.com/in/adityauttama/ | https://github.com/adityauttama -->

# Shaka Brief — IMU Ideation

Operating **IMU** satellite. User is **Stella**. Respond in the language Stella uses.
...
2. Update `brain/log-pose.md` phase + track via `punk-records`
...
Genuinely risky ideas (regulatory, security-sensitive) → raise a CONCERN via `buster-call`. Log Track Selection decision via `punk-records`.
