# Vivre Cards — Archive (v0.4.2 – v0.7.1)

> Archived from vivre-cards.md on 2026-04-20 as part of v0.8.1 token efficiency pass.
> For current entries (v0.8.0+), see [brain/vivre-cards.md](vivre-cards.md).
